...
public class TCPServer
{
    ...
    public static int count, G = 1019, N = 1823, port=20700, gIndex, portIndex, nIndex, numMessages = 0, clientKey, b;
    public static void main(String[] args)
    {
        ...
        System.out.println("Port opened. Use Ctrl+C to close.");
        do { run(); }while (true);
    }
    ...
    private static void run()
    {
        ...
        try
        {
            ...
            if(arr.isEmpty())
            {
                ...
                TCPServer.log = new FileWriter("chat.txt");
            }
...
//decrypt
            ...
            while (!message.equals("DONE"))
            {
                ...
                for(int i=0; i<TCPServer.arr.size();i++)
                {
                    ...
                    {
//encrypt
                        message = encrypt(message, temp.padd);
